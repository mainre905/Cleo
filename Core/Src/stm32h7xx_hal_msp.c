...
void HAL_I2C_MspInit(I2C_HandleTypeDef* hi2c)
{
  ...
  */
    ...
    PB7     ------> I2C1_SDA
    */
    GPIO_InitStruct.Pin = MOT_I2C_SCL_Pin|MOT_I2C_SDA_Pin;
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB7     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(MOT_I2C_SCL_GPIO_Port, MOT_I2C_SCL_Pin);

    HAL_GPIO_DeInit(MOT_I2C_SDA_GPIO_Port, MOT_I2C_SDA_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  /* USER CODE END TIM2_MspPostInit 0 */
    ...
    */
    GPIO_InitStruct.Pin = WPT_PWM_BOT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
    HAL_GPIO_Init(WPT_PWM_BOT_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = WPT_PWM_TOP_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
    HAL_GPIO_Init(WPT_PWM_TOP_GPIO_Port, &GPIO_InitStruct);
